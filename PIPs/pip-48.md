...
Unlike previous proposals based on off-chain certificates, this protocol modifies the Account structure to include a "Delegation Slot". This slot holds:  
...
Delegated Keys deliberately restrict functionality to **small, everyday payments**.  
...
State Update:  
If valid, the transaction is executed, and Account.DelegateAllowance is decremented by the total spent amount. The Account.Balance is reduced as usual.
